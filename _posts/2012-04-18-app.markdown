...
È importante che tu selezioni le istruzioni relativa al tuo sistema operativo - i comandi da eseguire con un pc Windows sono leggermente differenti da quelli per Mac o Linux.If you're having trouble check the Operating System switcher at the bottom of the commands.
